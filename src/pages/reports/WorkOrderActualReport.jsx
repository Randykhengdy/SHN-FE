...
export default function WorkOrderActualReportPage() {
  ...
  return (
    <PageLayout title="Laporan Work Order Actual" category="LAPORAN">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-bold">Laporan Work Order Actual</h1>
          <p className="text-muted-foreground">Generate laporan WO Actual dengan filter sederhana</p>
        </div>
