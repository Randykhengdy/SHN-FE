...
import { Search, Filter, Download, FileText, Eye, RefreshCw, Printer, CheckCircle, XCircle, AlertCircle, DollarSign } from "lucide-react";
...
export default function PembayaranPage() {
  ...
  return (
    <PageLayout title="Pembayaran" category="FINANCE">
      <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-4 mb-6">
        ...
        <Button onClick={() => {
          loadInvoices();
          loadSummary();
        }} disabled={loading} className="bg-blue-600 hover:bg-blue-700 w-full sm:w-auto">
