...
const ReturnToRackModal = ({ open, onOpenChange }) => {
    ...
    // Auto-focus item input when modal opens
    useEffect(() => {
        if (open) {
        ...
        <>
            <Dialog open={open} onOpenChange={onOpenChange}>
                <DialogContent className="w-full sm:max-w-3xl max-h-[90vh] overflow-y-auto">
                    <DialogHeader>
                        <DialogTitle className="text-xl">Kembalikan Barang ke Rak</DialogTitle>
                    </DialogHeader>
...
export default ReturnToRackModal;
