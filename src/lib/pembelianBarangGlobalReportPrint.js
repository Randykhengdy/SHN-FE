...
export const printPembelianBarangGlobalReport = (groupedData, startDate, endDate) => {
  ...
  const tableRowsRendering = jenisKeys.map(jenisKey => {
      ...
      items.forEach((item) => {
        ...
        rowsHtml += `
          <tr>
            ...
            <td valign="top" align="right">${formatCurrency(qty)}</td>
            <td valign="top" align="right">${formatCurrency(totalKg)}</td>
    ...
    rowsHtml += `
      <tr class="subtotal-row">
        <td colspan="2" align="right" style="font-weight: bold; border-top: 1px dotted #000; padding-right: 10px;">${jenisKey}</td>
        <td align="right" style="font-weight: bold; border-top: 1px dotted #000;">${formatCurrency(subQty)}</td>
        <td align="right" style="font-weight: bold; border-top: 1px dotted #000;">${formatCurrency(subTotalKg)}</td>
        <td align="right" style="font-weight: bold; border-top: 1px dotted #000;"></td>
  ...
  const documentHtml = `
    ...
    <head>
      ...
      <title>Pembelian Barang Global</title>
      <style>
        body {
    ...
    <body>
      <div class="toolbar">
        <span class="toolbar-title">Print Preview - Pembelian Barang Global</span>
