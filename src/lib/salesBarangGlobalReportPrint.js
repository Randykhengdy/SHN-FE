...
export const printSalesBarangGlobalReport = (data, dataRongsok, startDate, endDate) => {
  ...
  const renderItems = (itemsToRender, title) => {
    ...
    itemsToRender.forEach(item => {
      ...
      totalKeseluruhanBerat += itemKg;
      totalKeseluruhanJumlah += itemJumlah;
  ...
  const documentHtml = `
    ...
    <head>
      ...
      <title>Penjualan / Barang - Global</title>
      <style>
        body {
    ...
    <body>
      <div class="toolbar">
        <span class="toolbar-title">Print Preview - Penjualan / Barang - Global</span>
